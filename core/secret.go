...
func sealSecret(
	...
	wc, err := renameio.NewPendingFile(destPath, renameio.WithRoot(sm.root), renameio.WithPermissions(0o600))
	if err != nil {
...
func revealSecret(sm *SecretManager, revealedPath string) error {
	...
	dstFd, err := renameio.NewPendingFile(revealedPath, renameio.WithRoot(sm.root), renameio.WithPermissions(0o600))
	if err != nil {
