...
|----------------------------------------------------------------------|------|-------|----------------|-----------------------------------------------|-------------------------------|
| [**git-crypt**](https://github.com/AGWA/git-crypt)                   | C++  | 2013  | slow           | transparent (clean/smudge)                    | AES-256-CTR                   |
...
| [**keyringer**](https://keyringer.pw)                                | Bash | 2012  | active         | explicit encrypt/decrypt                      | GPG                           |
| [**BlackBox**](https://github.com/StackExchange/blackbox)            | Go   | 2013  | abandoned      | explicit encrypt/decrypt                      | GPG                           |
...
| [**agebox**](https://github.com/slok/agebox)                         | Go   | 2021  | slow           | none native²                                  | age (X25519 / SSH)            |
...
| [**secretspec**](https://secretspec.dev) | Rust       | 2025  | none (delegates to backend)                          | declares which secrets an app needs                  | delegated to backend (keyring, 1Password, AWS Secrets Manager, Vault, …) | local append-only access log; deeper auditing per backend |
...
|---------------------------------------------------------------------------|------------------------|-------------------------------|-----------------|-----------------------|-------------------|-----------------------------|
| [**HashiCorp Vault**](https://www.vaultproject.io)                        | self-hosted server     | AES-256-GCM (storage barrier) | ✓ (detailed)    | ✓ (policies + roles)  | ✓ (HCL)           | env-inject or agent         |
...
| [**Ansible Vault**](https://docs.ansible.com/ansible/latest/vault_guide/) | file-based (no server) | AES-256-CTR + HMAC-SHA256     | ✗               | ✗                     | ✓ (playbooks)     | committed ciphertext        |
